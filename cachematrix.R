...
### Using caching to speed up time consuming computations:

#            * Cache the results so that it can look them up later instead of computing them again.
#            * For example, maxtrix inversion is usually costly, especially when running inside of a               loop. 


#  The following two functions can compute and cache the inverse of a matrix.
